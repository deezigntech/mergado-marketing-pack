...
$alertDefaultData = [
	...
	'type' => 'success',
	'text' => sprintf(__('<strong>The %s feed is ready</strong>. You can now go to the List of feeds and create an export in the Mergado App.', 'mergado-marketing-pack'), $wizardName),
	'closable' => false,
	'closableAll' => false,
];
